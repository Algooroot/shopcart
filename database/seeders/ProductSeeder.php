...
class ProductSeeder extends Seeder
{
    ...
    {
        // Images e-commerce spécifiques - ordre correspondant aux noms de produits
        $productImages = [
            ...
            'https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8aGVhZHBob25lc3xlbnwwfHwwfHx8MA%3D%3D', // écouteur
        ];

        // Noms de produits correspondant aux images
        $productNames = [
            'Ukelele',
            'Iphone',
            'Macbook Pro',
